    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        //   console.log('Login Response:', response); // Debugging
          ...
          if (response.success) {
            ...
            setTimeout(() => {
              router.push('/admin/dashboard'); // Redirect after 2 seconds
            }, 2000);
          } else {
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center max-w-md flex flex-col justify-center">
                        ...
                        <p className="text-gray-600">You have successfully signed in as an Admin. You will be redirected shortly.</p>
                    </div>
                </div>
            )}
        </div>
